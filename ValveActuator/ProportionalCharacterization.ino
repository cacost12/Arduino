...
// Proportional Variable: Keeps track of flow throttle
float throttle;
...
void loop() {
  ...
  // Check if Angle has changed since last measurement
  if(ShaftAngle!=PreviousShaftAngle){

    // Calculate Flow Throttle
    throttle = ShaftAngleDeg*100.0/1306.2;
